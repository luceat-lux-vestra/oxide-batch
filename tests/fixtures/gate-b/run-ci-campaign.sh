#!/usr/bin/env bash
# Runs the M6 Gate B campaign the way CI runs it.
#
...
url="postgres://postgres:postgres@127.0.0.1:5432/oxide_batch_gate_b"
...
exec cargo run --package oxide-batch-xtask -- gate-b
