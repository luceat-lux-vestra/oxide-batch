#!/usr/bin/env bash
# Runs the M5 resource-bounds campaign the way CI runs it.
#
...
url="postgres://postgres:postgres@127.0.0.1:5432/oxide_batch_resource"
...
exec cargo run --package oxide-batch-xtask -- resource-bounds
