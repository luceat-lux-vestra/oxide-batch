...
//! back. M7 `#265` advanced the target to schema 5 and M7 `#276` advances
//! it to schema 6; the populated 4 -> 5 and 5 -> 6 boundaries are owned by
//! their dedicated design gates rather than duplicated here.
//!
