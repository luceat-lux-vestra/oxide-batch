...
| M4 graceful shutdown, stale detection, and explicit recovery | [M4 shutdown and stale-recovery contract](../architecture/shutdown-and-recovery.md) |
| M4 parallel steps, local partitions, aggregation, and budgets | [M4 bounded local-scale contract](../architecture/local-scale.md) |
| M4 operator CLI grammar, output, exit categories, and secrets | [M4 operator CLI and configuration contract](../operations/operator-cli.md) |
...
| M6 custom-component extension contracts | [Extension guide](../guides/extension-guide.md) |
| M6 `oxide-batch-test` usage | [Test-kit tutorial](../guides/test-kit-tutorial.md) |
