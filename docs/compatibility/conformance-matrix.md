...
| DOM-STEPEXEC-001 | 6.0.4 [domain] | StepExecution | Each step attempt records status, counts, context, and relationship | Typed step execution | Semantic | Implemented | M1/M2 | Metadata schema differs | R/R/R/R/R/N | [M1 exit](../project/m1-exit-evidence.md) | [Execution semantics](execution-semantics.md) | Counters/checkpoint M2 |
...
| LIFE-RESTART-001 | 6.0.4 [job] | Restart | Failed/stopped work resumes under explicit compatibility rules | New attempt from committed checkpoint | Behavioral | Planned | M2/M7 | Stronger definition-fingerprint guard | R/R/R/R/R/J | `restart_resumes_latest_committed_checkpoint` | [Execution semantics](execution-semantics.md) | ADR-0004 |
...
| LIFE-RECOVER-001 | 6.0.4 [metadata] | Recover | Ambiguous/orphaned work requires an explicit recovery decision | Evidence-based audited recover | Operational | Planned | M2/M4 | Stricter `UNKNOWN` handling | R/R/R/R/R/N | `orphan_requires_operator_decision` | [Execution semantics](execution-semantics.md) | Never automatic takeover |
| LIFE-DEFINITION-001 | 6.0.4 [job] | Definition evolution | Restart runs a compatible definition | Revision/manifest/fingerprint plus directed upgrade | Native equivalent | Planned | M2/M7 | Stronger fail-closed model | R/R/R/R/R/J | [ADR-0004](../architecture/decisions/0004-job-definition-restart-compatibility.md) | [Execution plan](../architecture/execution-plan.md) | RFC-0004 extension |
...
| STEP-CHUNK-001 | 6.0.4 [chunk] | Chunk lifecycle | Read/process/write repeats and commits at completion boundary | Typed bounded chunk engine | Behavioral | Implemented | M2/M6 | Rust component API | R/R/R/R/R/R | [M2 chunk runtime evidence](../project/m2-chunk-runtime-evidence.md) | [Item model](../architecture/item-processing-model.md) | PostgreSQL atomic persistence #43; full model M6 |
...
| STEP-STARTLIMIT-001 | 6.0.4 [step] | Start controls | Start limit and allow-start-if-complete affect repeat execution | Typed step restart controls | Behavioral | Planned | M7 | — | R/R/R/R/R/N | — | [Execution plan](../architecture/execution-plan.md) | — |
...
| ITEM-CHECKPOINT-001 | 6.0.4 [chunk] | Checkpoint | Only committed state determines resume position | Atomic checkpoint/context/counters | Behavioral | Planned | M2 | Own metadata schema | R/R/R/R/R/R | `restart_resumes_latest_committed_checkpoint` | [Execution semantics](execution-semantics.md) | — |
...
| ID | Source | Subcategory | Spring capability and observable semantics | OxideBatch equivalent | Parity | Status | Milestone | Known divergence | Evidence U/I/C/Cr/M/P | Evidence | Owner | Notes/dependencies |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FT-RETRY-001 | 6.0.4 [retry] | Retry | Typed policy bounds attempts and persists relevant counts | Typed retry policy/cache/backoff | Behavioral | Planned | M3/M6 | Error categories differ | R/R/R/R/R/R | `retry_limit_persists_across_restart` | [Item model](../architecture/item-processing-model.md) | — |
| FT-BACKOFF-001 | 6.0.4 [retry] | Backoff | Backoff follows policy and can be interrupted | Injected monotonic clock and cancellable backoff | Behavioral | Planned | M3/M6 | Native time API | R/R/R/R/J/R | — | [Execution semantics](execution-semantics.md) | — |
| FT-SKIP-001 | 6.0.4 [step] | Skip | Read/process/write skips are classified, counted, and listened to | Typed skip classifier/listeners/counters | Behavioral | Planned | M3/M6 | Error taxonomy differs | R/R/R/R/R/R | `skip_count_commits_with_chunk` | [Item model](../architecture/item-processing-model.md) | — |
| FT-ROLLBACK-001 | 6.0.4 [step] | Rollback/no-rollback | Classifier controls rollback without corrupting checkpoint semantics | Typed rollback capability policy | Behavioral | Planned | M3/M6 | Resource-scoped modes explicit | R/R/R/R/R/R | `rolled_back_chunk_replays` | [Execution semantics](execution-semantics.md) | — |
...
| LISTENER-ITEM-001 | 6.0.4 [api] | Chunk/item/skip/retry | Complete callback taxonomy observes or influences named boundaries | Typed interceptors plus non-authoritative events | Behavioral | Partial | M2/M3/M6 | Rust error/panic model | R/R/R/R/J/R | [M2 chunk runtime evidence](../project/m2-chunk-runtime-evidence.md) | [Item model](../architecture/item-processing-model.md) | Basic chunk listener only; item/skip/retry taxonomy remains |
| FLOW-SEQUENCE-001 | 6.0.4 [job] | Sequential/conditional | Exit outcome selects a deterministic next step | Compiled transition graph | Behavioral | Planned | M3/M7 | Rust definition syntax | R/R/R/R/R/J | `exit_status_selects_transition` | [Execution plan](../architecture/execution-plan.md) | Basic M3, complete M7 |
| FLOW-DECIDER-001 | 6.0.4 [job] | Decision | A decision node maps durable inputs to flow outcome | Typed decider node and persisted trace | Behavioral | Planned | M3/M7 | Native type/API | R/R/R/R/R/J | — | [Execution plan](../architecture/execution-plan.md) | — |
...
| ID | Source | Subcategory | Spring capability and observable semantics | OxideBatch equivalent | Parity | Status | Milestone | Known divergence | Evidence U/I/C/Cr/M/P | Evidence | Owner | Notes/dependencies |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DB-POSTGRES-001 | 6.0.4 [schema] | PostgreSQL | Durable metadata, locking, migrations, and supported queries | Reference PostgreSQL/SQLx adapter | Native equivalent | Implemented | M2/M8 | OxideBatch-owned schema | R/R/R/R/R/R | [PostgreSQL evidence](../project/m2-postgres-repository-evidence.md) | [Persistence](../operations/persistence-and-migrations.md) | Full chunk/restart pending |
...
| META-UPGRADE-001 | 6.0.4 [schema] | Schema lifecycle | Schema initialization and upgrade preserve supported metadata | Versioned adapter migrations and compatibility windows | Operational | Implemented | M2/M8/M14 | Own schema/version | R/R/R/R/R/R | [Schema migration](../operations/migrations/0001-initial-metadata.md) | [Persistence](../operations/persistence-and-migrations.md) | Multi-version evidence grows |
