...
| ITEM-READER-001 | 6.0.4 [item] | Reader | Reader returns ordered items/end and may persist state | Generic `ItemReader<I>` | Feature/behavioral | Verified | M2/M6 | Boxed current path; static proposed | R/R/R/R/R/R | [M2 component evidence](../project/m2-component-contract-evidence.md) | [Item model](../architecture/item-processing-model.md) | Full contract M6; Verified against released `oxide-batch` 0.5.0 (M5 Embedded Core Production Preview); see [M5 exit evidence](../project/m5-exit-evidence.md) |
