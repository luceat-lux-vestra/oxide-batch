...
| REPO-EXPLORE-001 | 6.0.4 [metadata] | JobExplorer | Read-only bounded inspection of executions and instances | Keyset-paginated redacted `JobExplorer` | Operational | Implemented | M1/M4/M7 | Query API differs; keyset only | R/R/R/J/R/R | [`inspection_redacts_record_contents`](../../crates/oxide-batch/tests/listeners.rs), [M4 operator services](../project/m4-operator-services-evidence.md), [shared service contract](../../crates/oxide-batch/tests/contract/services.rs) | [M4 operator, explorer, and retention](../architecture/operator-and-explorer-services.md) | The closed query set, cursor consistency, redacted projections, and bounds are implemented on the in-memory and PostgreSQL adapters; `list_step_partitions` returns rows only after issue #80, and index evidence on realistic history remains M4 exit work |
| REPO-OPERATOR-001 | 6.0.4 [metadata] | JobOperator | Launch/restart/stop/abandon/recover through guarded service | `JobOperator` application service | Operational | Implemented | M4/M7 | Explicit recover and idempotency; guard rejections are audited outcomes | R/R/R/R/R/R | [M4 operator services](../project/m4-operator-services-evidence.md), [shared service contract](../../crates/oxide-batch/tests/contract/services.rs) | [M4 operator, explorer, and retention](../architecture/operator-and-explorer-services.md) | The request envelope, operation-ID idempotency, action guards, optimistic conflicts, unknown outcomes, and audit are implemented; the owning runtime observes a durable stop request only after issue #78, and complete registry/operator behavior remains M7 |
...
| OBS-METRICS-001 | 6.0.4 [api] | Metrics/traces | Lifecycle, item counts, duration, and failures are observable | Vendor-neutral bounded telemetry schema | Native equivalent | Implemented | M4/M10 | Metric names/API differ; explicit cardinality budget | R/R/R/R/J/R | [M4 bounded telemetry](../project/m4-telemetry-evidence.md) | [Observability contract](../operations/observability-contract.md) | Metric names/units/labels, the fixed span hierarchy and safe fields, the per-family `200`-series budget, name allowlists, bounded drop-newest exporter queue, panic isolation, and separate flush deadline are implemented; overhead/soak and complete M10 concurrency instrumentation remain pending |

## Local and distributed scalability

| ID | Source | Subcategory | Spring capability and observable semantics | OxideBatch equivalent | Parity | Status | Milestone | Known divergence | Evidence U/I/C/Cr/M/P | Evidence | Owner | Notes/dependencies |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SCALE-PARSTEP-001 | 6.0.4 [scale] | Parallel steps | Independent flow branches execute concurrently and aggregate | Structured bounded split execution | Behavioral | Planned | M4/M10 | Explicit task tree/budget | R/R/R/R/J/R | — | [M4 bounded local scale](../architecture/local-scale.md) | Branch bounds, ownership, deterministic aggregation, and sequential fallback are closed by the [M4 design gate](../project/m4-design-gate-evidence.md); implementation is issue #80 and complete scale remains M10 |
...
| SCALE-LOCALPART-001 | 6.0.4 [scale] | Local partitioning | Durable partitions execute in bounded local workers | Local assignment/aggregation | Behavioral | Planned | M4/M10 | No lease or fencing in the local slice | R/R/R/R/R/R | — | [M4 bounded local scale](../architecture/local-scale.md) | Partition identity, single-invocation partitioner, durable restart state, aggregation, and budgets are closed by the [M4 design gate](../project/m4-design-gate-evidence.md); implementation is issue #80 and RFC-0009 remote semantics remain proposed |
