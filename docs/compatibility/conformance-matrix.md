...
| LIFE-ABANDON-001 | 6.0.4 [metadata] | Abandon | Operator makes an execution permanently non-restartable | Audited guarded abandon | Operational | Planned | M4/M7 | API/authorization differ | R/R/R/R/R/N | — | [M4 operator, explorer, and retention](../architecture/operator-and-explorer-services.md) | Guards, idempotency, authorization class, and audit are closed by the [M4 design gate](../project/m4-design-gate-evidence.md); implementation is issue #76 |
...
| REPO-EXPLORE-001 | 6.0.4 [metadata] | JobExplorer | Read-only bounded inspection of executions and instances | Keyset-paginated redacted `JobExplorer` | Operational | Partial | M1/M4/M7 | Query API differs; keyset only | R/R/R/J/R/R | [`inspection_redacts_record_contents`](../../crates/oxide-batch/tests/listeners.rs) | [M4 operator, explorer, and retention](../architecture/operator-and-explorer-services.md) | Query set, cursor consistency, projections, and bounds are closed by the [M4 design gate](../project/m4-design-gate-evidence.md); implementation is issue #76 |
| REPO-OPERATOR-001 | 6.0.4 [metadata] | JobOperator | Launch/restart/stop/abandon/recover through guarded service | `JobOperator` application service | Operational | Planned | M4/M7 | Explicit recover and idempotency | R/R/R/R/R/R | — | [M4 operator, explorer, and retention](../architecture/operator-and-explorer-services.md) | Request envelope, idempotency, guards, conflicts, and audit are closed by the [M4 design gate](../project/m4-design-gate-evidence.md); implementation is issue #76 and complete registry/operator behavior remains M7 |
...
| REPO-RETENTION-001 | 6.0.4 [metadata] | Retention | Bounded cleanup preserves running/held work and audit | `RetentionRepository` hold plus two-phase purge | Operational | Planned | M4/M8 | Stronger hold/audit rules; plan digest required | R/R/R/R/R/R | — | [M4 operator, explorer, and retention](../architecture/operator-and-explorer-services.md) | Eligibility, holds, plan/apply guards, ordering, batches, and audit are closed by the [M4 design gate](../project/m4-design-gate-evidence.md); implementation is issue #76 and portability remains M8 |
