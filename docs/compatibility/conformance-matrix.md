...
| JOB-CONCURRENCY-001 | Concurrent launches create one job instance | Job repository | Behavioral | — | `concurrent_launch_creates_single_instance` | Planned M2 | PostgreSQL locking differs |
...
| OBS-INSPECT-001 | Execution inspection redacts record contents | Metadata/operations | Operational | — | `inspection_redacts_record_contents` | Planned M1/M2 | API and schema differ |
