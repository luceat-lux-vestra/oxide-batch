...
| STEP-STARTLIMIT-001 | 6.0.4 [step] | Start controls | Start limit and allow-start-if-complete affect repeat execution | Typed step restart controls | Behavioral | Planned | M3/M7 | — | R/R/R/R/R/N | — | [Execution plan](../architecture/execution-plan.md) | Basic M3, complete M7 |
...
| FT-ROLLBACK-001 | 6.0.4 [step] | Rollback/no-rollback | Classifier controls rollback without corrupting checkpoint semantics | Typed rollback capability policy | Behavioral | Planned | M3/M6 | Resource-scoped modes explicit | R/R/R/R/R/R | `crash_before_commit_replays_chunk` | [Execution semantics](execution-semantics.md) | — |
