...
| IO-OBJECT-001 | 6.0.4 [api] | Object storage | Restartable resource read/write and publication | `ObjectStoreCapability` provider-neutral basics (M6 slice; `InMemoryObjectStore` fixture); S3/Azure/GCS capability adapters (M9) | Native equivalent | Implemented | M6/M9 | Cloud API differs | R/R/R/R/R/R | [M6 #150 evidence](../project/m6-150-multi-resource-evidence.md) | [Integration model](../architecture/integration-model.md) | M6 slice (provider-neutral get/put/stat/list, version-token, deterministic pagination) implemented in #150; full S3/Azure/GCS certification remains M9 |
