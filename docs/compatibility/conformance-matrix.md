...
| SCALE-LOCALPART-001 | 6.0.4 [scale] | Local partitioning | Durable partitions execute in bounded local workers | Local assignment/aggregation | Behavioral | Partial | M4/M10 | No lease or fencing in the local slice | R/R/R/R/R/R | [M4 local-scale plan](../project/m4-local-scale-plan-evidence.md), [partition repository](../project/m4-partition-repository-evidence.md) | Format-3 identity/budgets plus atomic schema-3 planning, byte-ordered reads, worker/result CAS, persisted-plan reuse, completed-result preservation, and checksum validation are implemented; owned worker execution, `UNKNOWN` blocking, parent aggregation, process-kill, and resource/sequential evidence remain issue #80, while RFC-0009 remote semantics remain proposed |
