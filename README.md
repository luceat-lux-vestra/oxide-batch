...
the local-scale plan plus durable partition-repository and atomic aggregation
slices are implemented but unreleased; owned local-parallel execution and M4
